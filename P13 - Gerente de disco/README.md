...
```
cd existing_repo
git remote add origin https://gitlab.com/so_ufpr/p13-gerente-de-disco.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/so_ufpr/p13-gerente-de-disco/-/settings/integrations)
