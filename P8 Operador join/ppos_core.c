...
// Estados das tarefas: Pronta (P), Terminada (T), Executando (E), Suspensa (S)
...
void task_exit (int exit_code) {
    ...
    task_t *aux = CurrTask->join_queue;
    for (; aux!=NULL ;) {
        task_resume(aux, (task_t **)&CurrTask->join_queue);
        aux = CurrTask->join_queue;
    }
